...
export class MyRobot extends THREE.Object3D {
    constructor(app,color, position) {
        ...
        const materialRobot = new THREE.MeshStandardMaterial({ color: this.color });
    ...
    createRobotHead(){
        ...
        const halfCylinder = new THREE.Mesh(cylinder, new THREE.MeshStandardMaterial({ color: 0x00ff00 }));
        ...
        const halfSphere= new THREE.Mesh(sphere, new THREE.MeshStandardMaterial({ color: 0x00ff00 }));
        ...
        const topNeck =  new THREE.Mesh(cylinder2, new THREE.MeshStandardMaterial({ color: 0x000000 }));
        topNeck.position.set(halfSphere.position.x, halfSphere.position.y - 1.01, halfSphere.position.z);
        this.add(topNeck); 
        const bottomNeck =  new THREE.Mesh(cylinder2, new THREE.MeshStandardMaterial({ color: 0x000000 }));
        ...
        const middleNeck =  new THREE.Mesh(cylinder3, new THREE.MeshStandardMaterial({ color: 0x000000 }));
    ...
    createRobotFace(){
        ...
        const glasses2 = new THREE.Mesh(rectangleGeometry, new THREE.MeshStandardMaterial({ color: 0x000000 }))
    ...
    createRobotBody(){
        ...
        const chest = new THREE.Mesh(cylinder, new THREE.MeshStandardMaterial({ color: 0x00ff00 }));
        ...
        const abdomen = new THREE.Mesh(cylinder2, new THREE.MeshStandardMaterial({ color: 0x00ff00 }));
        ...
        const hips = new THREE.Mesh(hipsGeometry, new THREE.MeshStandardMaterial({ color: 0x000000 }));
    ...
    createRobotLegs() {
        ...
        const legMaterial2 = new THREE.MeshStandardMaterial({ color: 0x000000 });
