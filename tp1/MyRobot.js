...
export class MyRobot extends THREE.Object3D {
    ...
    createRobotFace(){
        ...
        const glasses2 = new THREE.Mesh(rectangleGeometry, new THREE.MeshBasicMaterial({ color: 0x000000 }))
    ...
    createRobotLegs() {
        ...
        const legMaterial2 = new THREE.MeshBasicMaterial({ color: 0x000000 });
