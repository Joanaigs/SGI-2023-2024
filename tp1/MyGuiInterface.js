...
class MyGuiInterface  {
    ...
    init() {
        ...
        cameraFolder.add(this.app, 'activeCameraName', [ 'Perspective', 'Robot', 'Cake','Jornal','Vase Cylinder', 'Coil', 'Round Vase','Photo Frames','Carocha', 'Left Side Room Prepective','Right Side Room Prepective', 'Left','Right', 'Top', 'Front', 'Back' ] ).name("active camera");
