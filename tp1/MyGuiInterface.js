...
class MyGuiInterface {
    ...
    init() {
        ...
        const axis = this.datgui.addFolder('Axis');
        axis.add(this.contents, 'axisVisible').name("Visible").onChange(() => { this.contents.rebuildAxis() });
        ...
        const textureFolder = this.datgui.addFolder('Textures Floor Settings');
